                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img
                                                    src="{{asset('images//courses/demo-img-01.png')}}"
                                        ...
                                        <div class="contentCard-bottom">
                                            ...
                                            <div
                                                ...
                                                <a href="instructor-profile.html"
                                                    ...
                                                    <img src="{{asset('images//courses/7.png')}}"
                                            ...
                                            <div class="contentCard-more">
                                                ...
                                                <div class="book d-flex align-items-center">
                                                    <div class="icon">
                                                        <img src="{{asset('images//icon/book.png')}}"
                                                            alt="location" />
                                                    </div>
                                                    <span>37 Lesson</span>
                                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img
                                                    src="{{asset('images//courses/demo-img-02.png')}}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img
                                                    src="{{asset('images//courses/demo-img-03.png')}}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img
                                                    src="{{asset('images//courses/demo-img-04.png')}}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="#"><img
                                                    src="{{asset('images//courses/demo-img-05.png')}}"
                                                    alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                        ...
                                        <div class="students-feedback-item">
                                            <div class="feedback-rating">
                                                <div class="feedback-rating-start">
                                                    <div class="image">
                                                        <img src="{{asset('images//ellipse/user.jpg')}}"
                                                            alt="Image" />
                                                    </div>
                                                    <div class="text">
